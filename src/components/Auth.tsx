...
import { Music, Mail, Lock, User as UserIcon, Loader2, Apple, Phone } from 'lucide-react';
...
export default function Auth() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setError('Erro ao entrar com Google. Verifique se o provedor está ativado no console.');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleAppleSignIn = async () => {
    ...
    try {
      ...
      setError('Erro ao entrar com Apple. Verifique se o provedor está ativado no console.');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handlePhoneSignIn = () => {
    setError('O login via Telefone requer configuração adicional de SMS no console do Firebase.');
  };
